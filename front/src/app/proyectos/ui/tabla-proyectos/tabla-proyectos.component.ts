...
@Component({
  ...
  standalone: true,
  imports: [MatFormFieldModule, MatInputModule ,MatTableModule, DatePipe, MatPaginatorModule, MatSortModule, MatIcon, MatTooltip, MatIconButton],
...
export class TablaProyectosComponent implements OnChanges, AfterViewInit {
  ...
  displayedColumns = ['id', 'nombre', 'descripcion', 'fechaInicio', 'fechaFin', 'responsable', 'acciones'];
