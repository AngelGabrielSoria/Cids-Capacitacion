...
const obtenerDesarrolladores = async (): Promise<Desarrollador[]> => {
    try {
        return await DesarrolladorRepository.obtenerDesarrolladores();
    } catch (error: any) {
        throw error;
    }
};
...
const crearDesarrollador = async (payload: CrearDesarrolladorDto): Promise<Desarrollador> => {
    try {
        return await DesarrolladorRepository.crearDesarrollador(payload);
    } catch (error: any) {
        throw error;
    }
};
