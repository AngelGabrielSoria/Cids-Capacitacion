...
const obtenerDesarrollador = async (req: Request, res: Response): Promise<Response> => {
  try {
    const { id } = req.params;
...
const crearDesarrollador = async (req: Request, res: Response): Promise<Response> => {
  try {
...
const actualizarDesarrollador = async (req: Request, res: Response): Promise<Response> => {
  try {
    const { id } = req.params;
...
const eliminarDesarrollador = async (req: Request, res: Response): Promise<Response> => {
  try {
    const { id } = req.params;
